...
"""
Adapted from Create Your Own Finite Volume Fluid Simulation (With Python)
...
def main(resolution, timeDilation, timestep):
    ...
    return rhoData, vxData, vyData, PData, snaps
